...
async def get_financial_report(company_name: str, db) -> Dict[str, Any]:
    ...
    try:
        ...
        {stock.name}의 재무제표를 전문적으로 분석해주세요.
        ...
        다음 관점에서 분석해주세요:
        1. 매출 성장률 및 트렌드 분석
        2. 수익성 지표 (영업이익률, 순이익률) 평가
        3. 재무 안정성 및 부채 구조 검토
        4. 투자 위험도 종합 평가
        5. 최종 투자 등급 (A/B/C/D) 및 근거

        전문 증권분석사 관점에서 객관적이고 구체적으로 분석해주세요.
        긍정적 요소와 부정적 요소를 균형있게 제시하고,
        투자자가 의사결정에 활용할 수 있는 실질적인 조언을 포함해주세요.
        """
